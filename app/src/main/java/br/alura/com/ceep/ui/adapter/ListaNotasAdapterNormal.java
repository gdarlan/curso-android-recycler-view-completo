package br.alura.com.ceep.ui.adapter;
...
public class ListaNotasAdapterNormal extends BaseAdapter {

    private final Context context;
    private final List<Nota> notas;

    public ListaNotasAdapterNormal(Context context, List<Nota> notas) {
